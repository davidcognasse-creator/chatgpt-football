...
| 9 | Borac Banja Luka–Levski Sofia | simple | 1 | 33% |
...
| 15 | Kairat Almaty–Sutjeska | simple | 1 | 33% |

Répartition : 12 simples · **3 doubles** · **0 triples**
- **P(profit)** (gain ≥ coût) : **10.1 %** → rembourse dès **12/15** (rapport ~383 €)
- P(atteindre un rang, ≥ 12/15) : 10.6 % · espérance de gain (si modèle calibré) : ~276 €
...
- **P(profit)** (gain ≥ coût) : **15.4 %** → rembourse dès **12/15** (rapport ~383 €)
- P(atteindre un rang, ≥ 12/15) : 16.3 % · espérance de gain (si modèle calibré) : ~454 €
...
- **P(profit)** (gain ≥ coût) : **22.8 %** → rembourse dès **12/15** (rapport ~383 €)
- P(atteindre un rang, ≥ 12/15) : 24.4 % · espérance de gain (si modèle calibré) : ~733 €
