...
| 7 | Vardar Skopje–Kups | simple | N | 50% |
| 8 | Floriana FC–Shamrock | simple | 1 | 50% |
| 9 | Borac Banja Luka–Levski Sofia | simple | 2 | 51% |
...
| 15 | Kairat Almaty–Sutjeska | DOUBLE | 1 / N | 100% |

Répartition : 12 simples · **3 doubles** · **0 triples**
- **P(profit)** (gain ≥ coût) : **14.4 %** → rembourse dès **12/15** (rapport ~380 €)
- P(atteindre un rang, ≥ 12/15) : 15.3 % · espérance de gain (si modèle calibré) : ~452 €
...
- **P(profit)** (gain ≥ coût) : **21.1 %** → rembourse dès **12/15** (rapport ~380 €)
- P(atteindre un rang, ≥ 12/15) : 22.8 % · espérance de gain (si modèle calibré) : ~721 €
...
- **P(profit)** (gain ≥ coût) : **29.8 %** → rembourse dès **12/15** (rapport ~380 €)
- P(atteindre un rang, ≥ 12/15) : 32.8 % · espérance de gain (si modèle calibré) : ~1118 €
