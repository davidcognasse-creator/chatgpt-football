...
(function () {
  ...
  const T = {
    ...
    es: {
      ...
      card_scoreia: "Marcador IA", pf_poly_note: "estimado · ≈ precio de mercado", pf_book: "cuotas Unibet (margen ~6 %)", his_aet: "pró.", his_pens: "pen.", pf_title: "Cartera virtual", pf_virtual: "Ficticio", pf_sub: "Apuesta ficticia de {stake} € en cada partido donde la IA daba al favorito por encima del 50 %.", pf_bets: "Apuestas", pf_wl: "Ganadas / Perdidas", pf_staked: "Total apostado", pf_pnl: "Ganancia neta", pf_roi: "Rentabilidad", pf_edge: "Apuestas con valor", pf_warn: "Simulación ficticia educativa — sin apuestas reales. Cada apuesta tenía en realidad valor esperado negativo (prob. IA < precio de mercado): un buen porcentaje de acierto no garantiza ganar dinero.", card_finished: "Finalizado", card_result: "Resultado", card_ai_short: "IA:", card_conf: "Confianza", card_draw: "Empate",
