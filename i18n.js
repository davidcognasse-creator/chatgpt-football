...
(function () {
  ...
  const T = {
    fr: {
      ...
      nav_card: "Ma Carte Panini", card_eyebrow: "Carte à collectionner", card_h1: "Crée ta carte Panini", card_lede: "Ta carte à ton effigie, façon vignette de foot. Remplis le formulaire, ajoute ta photo, télécharge et partage-la pour faire connaître le site.", card_form_title: "🎴 Ta carte", card_photo: "Photo", card_name: "Nom", card_role: "Poste", card_country: "Pays", card_company: "Entreprise / équipe", card_stats: "Statistiques (0–99)", card_download: "📥 Télécharger", card_share: "📤 Partager", card_photo_ph: "Ajoute ta photo", card_jersey: "👕 Habiller d'un maillot aux couleurs du pays",
    ...
    de: {
      ...
      nav_card: "Meine Panini-Karte", card_eyebrow: "Sammelkarte", card_h1: "Erstelle deine Panini-Karte", card_lede: "Deine eigene Karte im Fußball-Sticker-Stil. Fülle das Formular aus, füge dein Foto hinzu, lade sie herunter und teile sie.", card_form_title: "🎴 Deine Karte", card_photo: "Foto", card_name: "Name", card_role: "Position", card_country: "Land", card_company: "Firma / Team", card_stats: "Werte (0–99)", card_download: "📥 Herunterladen", card_share: "📤 Teilen", card_photo_ph: "Foto hinzufügen", card_jersey: "👕 Trikot in den Landesfarben anziehen",
    ...
    ar: {
      ...
      nav_card: "بطاقة Panini الخاصة بي", card_eyebrow: "بطاقة للجمع", card_h1: "أنشئ بطاقة Panini الخاصة بك", card_lede: "بطاقتك الخاصة على طراز ملصقات كرة القدم. املأ النموذج، أضف صورتك، نزّلها وشاركها للتعريف بالموقع.", card_form_title: "🎴 بطاقتك", card_photo: "الصورة", card_name: "الاسم", card_role: "المنصب", card_country: "البلد", card_company: "الشركة / الفريق", card_stats: "الإحصاءات (0–99)", card_download: "📥 تنزيل", card_share: "📤 مشاركة", card_photo_ph: "أضف صورتك", card_jersey: "👕 ارتداء قميص بألوان البلد",
