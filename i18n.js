...
(function () {
  ...
  const T = {
    ...
    pt: {
      ...
      card_scoreia: "Placar IA", nav_gains: "Apostas", nav_loto: "Loto", gains_lede: "Se tivéssemos apostado 20 € fictícios em cada jogo onde a IA dava o favorito acima de 50 %. Ganhos teóricos Unibet vs Polymarket. Simulação educativa · sem apostas reais.", gains_c_match: "Jogo", gains_c_pick: "Palpite IA", gains_c_odds: "Odd", gains_c_res: "Resultado", gains_c_uni: "Total Unibet", gains_c_poly: "Total Polymarket", pf_poly_note: "estimado · ≈ preço de mercado", pf_book: "odds Unibet (margem ~6 %)", his_aet: "a.p.", his_pens: "pên.", pf_title: "Carteira virtual", pf_virtual: "Fictício", pf_sub: "Aposta fictícia de {stake} € em cada jogo onde a IA dava o favorito acima de 50 %.", pf_bets: "Apostas", pf_wl: "Ganhas / Perdidas", pf_staked: "Total apostado", pf_pnl: "Lucro líquido", pf_roi: "Rentabilidade", pf_edge: "Apostas com valor", pf_warn: "Simulação fictícia educativa · sem apostas reais. Cada aposta tinha na verdade valor esperado negativo (prob. IA < preço de mercado): uma boa taxa de acerto não garante lucro.", card_finished: "Terminado", card_result: "Resultado", card_ai_short: "IA:", card_conf: "Confiança", card_draw: "Empate",
