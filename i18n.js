...
(function () {
  ...
  const T = {
    fr: {
      ...
      nav_card: "Ma carte", card_eyebrow: "Carte à collectionner", card_h1: "Crée ta carte Panini", card_lede: "Ta carte à ton effigie, façon vignette de foot. Remplis le formulaire, ajoute ta photo, télécharge et partage-la pour faire connaître le site.", card_form_title: "🎴 Ta carte", card_photo: "Photo (reste sur ton appareil)", card_name: "Nom", card_role: "Poste", card_country: "Pays", card_company: "Entreprise / équipe", card_stats: "Statistiques (0–99)", card_download: "📥 Télécharger", card_share: "📤 Partager", card_photo_ph: "Ajoute ta photo", card_jersey: "👕 Habiller d'un maillot aux couleurs du pays", card_share_hint: "Astuce : télécharge l'image puis joins-la à ton post (sur Instagram, partage depuis ta galerie).", card_privacy: "🔒 Tout se passe dans ton navigateur : ta photo n'est jamais envoyée à un serveur.", card_foot: "Image générée localement à des fins ludiques. Marque Panini™ citée à titre d'inspiration, sans affiliation.", card_share_text: "J'ai créé ma carte façon Panini sur chatgpt.football ⚽ — crée la tienne et affronte l'IA en pronostics !",
    ...
    en: {
      ...
      nav_card: "My card", card_eyebrow: "Collectible card", card_h1: "Create your Panini card", card_lede: "Your own card in football-sticker style. Fill in the form, add your photo, download and share it to spread the word.", card_form_title: "🎴 Your card", card_photo: "Photo (stays on your device)", card_name: "Name", card_role: "Role", card_country: "Country", card_company: "Company / team", card_stats: "Stats (0–99)", card_download: "📥 Download", card_share: "📤 Share", card_photo_ph: "Add your photo", card_jersey: "👕 Add a jersey in the country's colours", card_share_hint: "Tip: download the image then attach it to your post (on Instagram, share from your gallery).", card_privacy: "🔒 Everything happens in your browser: your photo is never sent to a server.", card_foot: "Image generated locally for fun. Panini™ trademark cited as inspiration, no affiliation.", card_share_text: "I made my Panini-style card on chatgpt.football ⚽ — make yours and take on the AI in predictions!",
    ...
    pt: {
      ...
      nav_card: "Minha carta", card_eyebrow: "Carta colecionável", card_h1: "Crie sua carta Panini", card_lede: "Sua própria carta no estilo figurinha de futebol. Preencha o formulário, adicione sua foto, baixe e compartilhe para divulgar o site.", card_form_title: "🎴 Sua carta", card_photo: "Foto (fica no seu dispositivo)", card_name: "Nome", card_role: "Cargo", card_country: "País", card_company: "Empresa / time", card_stats: "Estatísticas (0–99)", card_download: "📥 Baixar", card_share: "📤 Compartilhar", card_photo_ph: "Adicione sua foto", card_jersey: "👕 Vestir uma camisa nas cores do país", card_share_hint: "Dica: baixe a imagem e anexe à sua publicação (no Instagram, compartilhe da galeria).", card_privacy: "🔒 Tudo acontece no seu navegador: sua foto nunca é enviada a um servidor.", card_foot: "Imagem gerada localmente para diversão. Marca Panini™ citada como inspiração, sem afiliação.", card_share_text: "Criei minha carta estilo Panini no chatgpt.football ⚽ — crie a sua e desafie a IA nos palpites!",
    ...
    de: {
      ...
      nav_card: "Meine Karte", card_eyebrow: "Sammelkarte", card_h1: "Erstelle deine Panini-Karte", card_lede: "Deine eigene Karte im Fußball-Sticker-Stil. Fülle das Formular aus, füge dein Foto hinzu, lade sie herunter und teile sie.", card_form_title: "🎴 Deine Karte", card_photo: "Foto (bleibt auf deinem Gerät)", card_name: "Name", card_role: "Position", card_country: "Land", card_company: "Firma / Team", card_stats: "Werte (0–99)", card_download: "📥 Herunterladen", card_share: "📤 Teilen", card_photo_ph: "Foto hinzufügen", card_jersey: "👕 Trikot in den Landesfarben anziehen", card_share_hint: "Tipp: Lade das Bild herunter und füge es deinem Beitrag bei (bei Instagram aus der Galerie teilen).", card_privacy: "🔒 Alles passiert in deinem Browser: dein Foto wird nie an einen Server gesendet.", card_foot: "Bild lokal zum Spaß erzeugt. Marke Panini™ als Inspiration genannt, ohne Zugehörigkeit.", card_share_text: "Ich habe meine Panini-Karte auf chatgpt.football erstellt ⚽ — erstelle deine und tritt gegen die KI an!",
    ...
    it: {
      ...
      nav_card: "La mia figurina", card_eyebrow: "Figurina da collezione", card_h1: "Crea la tua figurina Panini", card_lede: "La tua figurina in stile album di calcio. Compila il modulo, aggiungi la tua foto, scaricala e condividila per far conoscere il sito.", card_form_title: "🎴 La tua figurina", card_photo: "Foto (resta sul tuo dispositivo)", card_name: "Nome", card_role: "Ruolo", card_country: "Paese", card_company: "Azienda / squadra", card_stats: "Statistiche (0–99)", card_download: "📥 Scarica", card_share: "📤 Condividi", card_photo_ph: "Aggiungi la tua foto", card_jersey: "👕 Indossa una maglia nei colori del paese", card_share_hint: "Suggerimento: scarica l'immagine e allegala al tuo post (su Instagram, condividi dalla galleria).", card_privacy: "🔒 Tutto avviene nel tuo browser: la tua foto non viene mai inviata a un server.", card_foot: "Immagine generata localmente per gioco. Marchio Panini™ citato come ispirazione, senza affiliazione.", card_share_text: "Ho creato la mia figurina stile Panini su chatgpt.football ⚽ — crea la tua e sfida l'IA nei pronostici!",
    ...
    sw: {
      ...
      nav_card: "Kadi yangu", card_eyebrow: "Kadi ya kukusanya", card_h1: "Tengeneza kadi yako ya Panini", card_lede: "Kadi yako mwenyewe kwa mtindo wa stika za mpira. Jaza fomu, ongeza picha yako, pakua na uishiriki kueneza habari za tovuti.", card_form_title: "🎴 Kadi yako", card_photo: "Picha (inabaki kwenye kifaa chako)", card_name: "Jina", card_role: "Cheo", card_country: "Nchi", card_company: "Kampuni / timu", card_stats: "Takwimu (0–99)", card_download: "📥 Pakua", card_share: "📤 Shiriki", card_photo_ph: "Ongeza picha yako", card_jersey: "👕 Vaa jezi ya rangi za nchi", card_share_hint: "Kidokezo: pakua picha kisha uiambatishe kwenye chapisho lako (kwenye Instagram, shiriki kutoka kwenye matunzio).", card_privacy: "🔒 Kila kitu kinafanyika kwenye kivinjari chako: picha yako haitumwi kamwe kwa seva.", card_foot: "Picha imetengenezwa ndani kwa ajili ya burudani. Chapa ya Panini™ imetajwa kama msukumo, bila uhusiano.", card_share_text: "Nimetengeneza kadi yangu ya mtindo wa Panini kwenye chatgpt.football ⚽ — tengeneza yako na ushindane na AI katika ubashiri!",
    ...
    ar: {
      ...
      nav_card: "بطاقتي", card_eyebrow: "بطاقة للجمع", card_h1: "أنشئ بطاقة Panini الخاصة بك", card_lede: "بطاقتك الخاصة على طراز ملصقات كرة القدم. املأ النموذج، أضف صورتك، نزّلها وشاركها للتعريف بالموقع.", card_form_title: "🎴 بطاقتك", card_photo: "الصورة (تبقى على جهازك)", card_name: "الاسم", card_role: "المنصب", card_country: "البلد", card_company: "الشركة / الفريق", card_stats: "الإحصاءات (0–99)", card_download: "📥 تنزيل", card_share: "📤 مشاركة", card_photo_ph: "أضف صورتك", card_jersey: "👕 ارتداء قميص بألوان البلد", card_share_hint: "نصيحة: نزّل الصورة ثم أرفقها بمنشورك (على إنستغرام، شارك من معرض الصور).", card_privacy: "🔒 كل شيء يحدث في متصفحك: صورتك لا تُرسَل أبدًا إلى خادم.", card_foot: "صورة مُولَّدة محليًا للتسلية. علامة Panini™ مذكورة للإلهام دون أي ارتباط.", card_share_text: "أنشأت بطاقتي على طراز Panini على chatgpt.football ⚽ — أنشئ بطاقتك وتحدَّ الذكاء الاصطناعي في التوقعات!",
